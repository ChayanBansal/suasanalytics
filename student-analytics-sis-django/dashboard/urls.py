...
urlpatterns=[
    ...
    # urls of corr 2
    path('corrView2/getEnrollYear', views.corr_view3_getEnrollYear),
    path('corrView2/getSection', views.corr_view3_getSection),
    path('corrView2/updateVisualization', views.corr_view3_updateVisualization),
